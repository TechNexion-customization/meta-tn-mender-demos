...
DESCRIPTION = "The docker Update Module installs a docker container in the target."
...
do_install_class-native() {
    install -d ${D}/${bindir}
    install -m 755 ${S}/support/modules-artifact-gen/docker-artifact-gen ${D}/${bindir}/docker-artifact-gen
}

FILES_${PN}-class-native += "${bindir}/docker-artifact-gen"
